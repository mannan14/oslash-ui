...

                {
                    ...
                    <>
                        <Menu.Button className={`focus:outline-none`}>
                            <svg className= {`${open ?  ``:``} mx-auto pb-6 w-10 text-[#6B7280]`} viewBox="0 0 40 40" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <Menu.Items className="absolute left-4 bottom-16 z-10 w-[162px] rounded-lg p-2 bg-white shadow-md focus:outline-none active:outline-none">
                            <div className="flex flex-col">
                                {
