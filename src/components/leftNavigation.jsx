...
export default function LeftNavigation(){
    ...
    return(
        <div className="flex flex-col justify-between w-[56px] pb-4 bg-gray-50">
            ...
            <div className="flex flex-col">
                ...
                <div className="">
                    <button 
                    className={`group flex flex-col mx-2 mt-2 text-center items-center hover:cursor-pointer`}
                ...
                <div className="mx-auto"> 
                    ...
                    className={`group mt-4 hover:cursor-pointer`}
                    >
                        <svg className={`${activeTab === `Shortcuts` ? `text-gray-900 bg-blue-100 hover:bg-blue-100` : `text-gray-500 group-hover:text-gray-900 group-hover:bg-gray-100 group-active:bg-blue-100`} w-10 mx-auto p-2 rounded-lg `} viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
